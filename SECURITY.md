...
- `@minions-component-evals/sdk` (npm package)
- `minions-component-evals` (PyPI package)
- `@minions-component-evals/cli` (npm package)
- The minions-component-evals web playground
- The minions-component-evals documentation site
