...
/**
 * @minions-component-evals/cli — CLI for Minions Component-evals
 *
...
import { customTypes } from '@minions-component-evals/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Component-evals'));
        console.log(chalk.dim('Pipeline-level benchmarks for RAG, routing, and classification'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-component-evals/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-component-evals/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-component-evals')}`);
